...
algs<-c("NSGAII","SMSEMOA","GDE3","IBEA","MOCell","MOEAD","PAES","RandomSearch")
boxplot(NSGAII,SMSEMOA,GDE3,IBEA,MOCell,MOEAD,PAES,RandomSearch,names=algs, notch = FALSE)
titulo <-paste(indicator, problem, sep=":")
title(main=titulo)
}
par(mfrow=c(1,1))
indicator<-"HV"
qIndicator(indicator, "MyProblemDouble")
