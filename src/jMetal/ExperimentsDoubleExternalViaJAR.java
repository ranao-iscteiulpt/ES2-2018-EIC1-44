...
public class ExperimentsDoubleExternalViaJAR {
	...
	public void startOptimization (Problem problem, String variableType, DefaultListModel algorithmsList, DefaultTableModel fitnessVariables) throws IOException {
		this.algorithmsList = algorithmsList;

		String experimentBaseDirectory = "experimentBaseDirectory";

		List<ExperimentProblem<DoubleSolution>> problemList = new ArrayList<>();
		problemList.add(new ExperimentProblem<>(new MyProblemDoubleExternalViaJAR(problem, variableType, algorithmsList, fitnessVariables)));
